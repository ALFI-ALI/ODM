...
function setupEventListeners() {
 ...
 /* function boll(){
    // Add a click event listener to the "Show Selected Saiyan" button
      ...
      let saiyan = saiyans.find(s => s.name === selectedSaiyan);
      display.textContent = `Name: ${saiyan.name}, Power Level: ${saiyan.powerLevel}`;   
  }

  document.getElementById('showDetailsBtn').addEventListener('click',boll);*/
  ...
  showDetailsBtn.addEventListener("click", showSelectedSaiyanChange);
...
function showSelectedSaiyanChange() {
    ...
    const detailsArea = document.getElementById("saiyanDetails"); // Get the paragraph element to display the details
    //const dropdownn = document.getElementById("showDetailsBtn"); 
